...
const Fridge = () => {
  ...
  const API_KEY = 'edb873e4c511412ab341a50963c0f518'; 
        ...
        <div className="ingredients-list">
          {ingredients.map((ingredient, index) => (
            <div key={index} className="ingredient-item">
              ...
              <button onClick={() => handleDeleteIngredient(index)} className="x">X</button>
            </div>
          ))}
        </div>
      </div>
      <button onClick={handleSearchRecipes} id="search">Search Recipes</button>
            ...
            <div>
              {recipes.map((recipe) => (
                ...
                >
                  ...
                  <p className="used-missing">Used Ingredients: {recipe.usedIngredientCount}</p>
                  <p className="used-missing">Missing Ingredients: {recipe.missedIngredientCount}</p>
                </div>
              ))}
            </div>
          )}
